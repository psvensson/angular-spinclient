  ...
  angular.module('ngSpinclient', ['uuid4', 'ngMaterial']).factory('spinclient', function(uuid4, $q, $rootScope) {
    ...
    'spinclient', function(client) {
      return {
        restrict: 'AE',
        replace: false,
        template: '<div > <spinlist listmodel="listmodel" list="list" onselect="onselect" ondelete="ondelete" edit="edit" search="search" searchfunc="searchfunc"></spinlist> </div>',
        scope: {
          listmodel: '=listmodel',
          edit: '=edit',
          onselect: '&',
      ...
      return {
        ...
        controller: function($scope) {
          ...
          $scope.doSearch = function(v) {
            ...
            if ($scope.searchfunc) {
              return $scope.searchfunc(v, $scope.qproperty, $scope.qvalue, $scope.selectedindex);
            } else {
          ...
          $scope.renderPageSelector = function() {
            ...
            if (count < 10) {
              ...
              $scope.listcount.length = parseInt(count / 10) + ((ref = (count % 10) > 0) != null ? ref : {
                1: 0
              });
            }
          ...
          $scope.renderList = function() {
            ...
            if ($scope.list.length > 10) {
              slice = [];
              for (x = j = ref = base, ref1 = base + 10; ref <= ref1 ? j <= ref1 : j >= ref1; x = ref <= ref1 ? ++j : --j) {
                id = $scope.list[x];
                slice.push(id);
              }
            }
