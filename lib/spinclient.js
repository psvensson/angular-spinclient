      ...
      return {
        ...
        controller: function($scope) {
          ...
          $scope.renderList = function() {
            var i, j, len, modelid, ref, results1;
            $scope.expandedlist = [];
        ...
        controller: function($scope) {
          ...
          return $scope.selectModel = function(item, type, propname) {
            ...
            return $mdDialog.show({
              ...
              template: '<md-dialog aria-label="selectdialog"> <md-content> <md-button class="md-raised" ng-click="addModel(item, type, propname)">New {{type}}</md-button> <md-button class="md-raised" ng-click="hide()">Close</md-button> <spinlist listmodel="type" list="list" edit="true" onselect="onselect" ondelete="ondelete"></spinlist> </md-content> </md-dialog>'
            });
          };
        }
      };
